...
\geometry{a4paper,left=35mm,right=25mm,top=25mm,bottom=40mm}
%prevent vertical alignment spaced equally if using twosided layout (happens if page isn't filled down to the bottom)
\raggedbottom
\usepackage[
