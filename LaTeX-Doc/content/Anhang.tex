...
\lstinputlisting[language=gp, firstline=180, lastline=191]{../PARI/algorithms.gp}

\emph{printEgypFrac(arguments)} nimmt eine Liste mit Argumenten entgegen und gibt die String-Konkatenation dieser zurück.
\lstinputlisting[language=gp, firstline=216, lastline=233]{../PARI/algorithms.gp}
...
\lstinputlisting[language=gp, firstline=159, lastline=178]{../PARI/algorithms.gp}
...
\lstinputlisting[language=gp, firstline=193, lastline=213]{../PARI/algorithms.gp}