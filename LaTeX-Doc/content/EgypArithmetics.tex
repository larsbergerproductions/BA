...
\subsection{Ägyptische Multiplikation}\label{subsec:egypMult}
	...
	Diese Methode funktioniert, da jede natürliche Zahl $n \in \N$ als \improvement{Beweis/ Quelle!} Summe paarweise verschiedener Zweierpotenzen darstellbar ist. Es wird im Allgemeinen angezweifelt, dass dies von den Ägyptern je formal bewiesen wurde, aber die Nutzung zeigt, dass sie diesen Zusammenhang zumindest erkannt hatten. \cite{Burton2011}
...
kam dabei nicht in Frage, da die Ägypter es als ,,unnatürlich'' ansahen, dass es mehr als diesen einen, wahren Teiler $\uf{b}$ einer Zahl geben sollte. \todo{Seitenzahl}\cite[p.]{Burton2011}\\
